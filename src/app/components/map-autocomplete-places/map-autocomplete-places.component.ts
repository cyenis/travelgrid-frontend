...
@Component({
  selector: 'app-map-autocomplete-places',
  templateUrl: './map-autocomplete-places.component.html',
  styleUrls: ['./map-autocomplete-places.component.css']
})
export class MapAutocompletePlacesComponent implements OnInit {
